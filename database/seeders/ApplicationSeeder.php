...
class ApplicationSeeder extends Seeder
{
    public function run(): void
    {
        $applications = [
            ...
            ['student_id' => 12, 'serial_number' => 'IRB-2026-007', 'title' => 'أثر العلاج الطبيعي المكثف بعد جراحات استبدال مفصل الركبة', 'principal_investigator' => 'د. يوسف الشناوي', 'current_stage' => 'awaiting_payment', 'is_blinded' => true, 'created_at' => '2026-04-22 09:00:00'],
            ...
            ['student_id' => 15, 'serial_number' => 'IRB-2026-010', 'title' => 'مضاعفات جراحات المياه البيضاء وعلاقتها بالأمراض المزمنة', 'principal_investigator' => 'د. سارة كمال', 'current_stage' => 'awaiting_payment', 'is_blinded' => true, 'created_at' => '2026-04-23 08:30:00'],
