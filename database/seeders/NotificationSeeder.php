...
class NotificationSeeder extends Seeder
{
    public function run(): void
    {
        $notifications = [
            ...
            ['user_id' => 13, 'application_id' => 8, 'message' => 'تهانينا! تم اعتماد بحثك (IRB-2026-008) نهائياً وإصدار شهادة IRB.', 'channel' => 'system', 'is_read' => false, 'email_sent' => true, 'created_at' => '2026-02-01 10:05:00'],
